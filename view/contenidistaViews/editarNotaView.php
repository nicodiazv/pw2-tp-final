                ...
                <div class="form-row">
                  ...
                  <div class="col-md-6 form-group">
                    <input type="text" name="ubicacion" class="form-control" id="ubicacion" placeholder="Ubicación de la nota"
                      required value="{{ubicacion_nombre}}">
                      <input type="hidden" name="place_id" id="place_id" value="{{ubicacion_place_id}}">
                      <input type="hidden" name="lat" id="lat" value="{{ubicacion_lat}}">
                      <input type="hidden" name="lng" id="lng" value="{{ubicacion_lng}}">
                  </div>
                  <div class="col-md-6 form-group ">
                    <input type="file" class="custom-file-input" id="uploadedImage" name="uploadedImage"
                      aria-describedby="inputGroupFileAddon01" value="{{imagen_nombre}}">
                  ...
                  <div class="input-group mb-3">
                    ...
                    <input type="text" class="form-control" id="basic-url" name="enlace" aria-describedby="basic-addon3" value="{{enlace}}" >
                  </div>
